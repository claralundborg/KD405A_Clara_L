...
public class TestClass {
	...
	public static void main(String[] args) {
		...
		// Hämtar en sträng med parametrarna: nummer på startdestination samt slutdestination och antal resultat.
	   ...
	   System.out.println("// Stations when searching for stations containing \"Malmö\"");
